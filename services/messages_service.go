...
func (msg *messagesService) GetMessage(msgId int64) (*domain.Message, error_utils.MessageErr) {
...
func (msg *messagesService) GetAllMessages() ([]domain.Message, error_utils.MessageErr) {
...
func (msg *messagesService) CreateMessage(message *domain.Message) (*domain.Message, error_utils.MessageErr) {
...
func (msg *messagesService) UpdateMessage(message *domain.Message) (*domain.Message, error_utils.MessageErr) {
	if err := message.Validate(); err != nil {
		return nil, err
	}
